...
def generateSampleFile(sptree,genesPerSp):
	lines=[]
	for leaf in sptree.leaf_nodes():
		lines.append(str(leaf.taxon.label)+' '+str(genesPerSp))
	return lines

def generateAllMonoConcordantTrees(sptree,genesPerSp):
